...
(function(){
  ...
  function openAuth(){
    ...
    d.innerHTML=`<div style="background:#150e10;border:1px solid #2a1d22;border-radius:20px;max-width:380px;width:100%;padding:26px;color:#f4e8e3">
      ...
      <p style="color:#b69089;font-size:.88rem;margin:4px 0 18px">Sign in with Google to save your bookshelf and ratings. We only ever store your email and your shelf — nothing else.</p>
